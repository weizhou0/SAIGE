...
void NullGenoClass::set_Diagof_StdGeno_LOCO(){
        int Nnomissing = getNnomissing();
        int chrlength = startIndexVec.n_elem;
        mtx_DiagStd_LOCO.zeros(Nnomissing, chrlength);
        Msub_MAFge_minMAFtoConstructGRM_byChr.zeros(chrlength);
        int starti, endi;
